...
<body>
	...
	<div style="width: 85%; margin: 0 auto;">
		...
		<div class="div3">
			...
			<form action="Comment!insertComment.action" style="float: left; width:90%" method="post">
				<!-- 获得当前歌曲id-->
				<input type="text" value="${music.id}" name="music.id">
				<textarea rows="4" style="width: 100%" placeholder="评论" name="comment.content"></textarea>
